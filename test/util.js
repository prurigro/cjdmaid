...
describe("util", function() {
    describe("#expanduser()", function() {
        it("should replace \"~\" to userdir", function() {
            ...
            assert.ok(util.expanduser("~/somestuff") === process.env.HOME + "/somestuff");
        });
    });
    ...
    describe("#generatePassword()", function() {
        it("length should be correct", function(done) {
            var leng = 30;
            when(
            util.generatePassword(leng)).then(function(result) {
        ...
        it("should be fast enough", function(done) {
            ...
            when(
            timeout(10, util.generatePassword(leng))).then(function() {
